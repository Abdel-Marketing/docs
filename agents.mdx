...
<Check>
  [Ready to see them work together?](https://launchpulse.ai/)\
...
<AccordionGroup>
  ...
  <Accordion title="GitHub Integration Agent">
    The **GitHub Integration Agent** connects LaunchPulse to your existing dev workflow.
  ...
  <Accordion title="QA Automation Engineer – Self-Testing Browser Agent 🔍">
...
<Check>
  <strong><a href="/dashboard">Start your first agent-powered build now.</a></strong>
   \
