---
title: "How to Write a Good Prompt for the AI App Builder"
description: "Write a strong AI app builder prompt for LaunchPulse so it builds the right features, data and workflows the first time."
icon: "pen-nib"
---
...
<AccordionGroup>
  <Accordion title="What makes a good AI app builder prompt?">
  ...
  <Accordion title="Should I describe the design or the features first?">
  ...
  <Accordion title="How detailed should my prompt be?">
  ...
  <Accordion title="Can I change the app after the first prompt?">
    Yes. Building is iterative. Use focused follow-up prompts to add, change or remove features one at a time.
  </Accordion>

  <Accordion title="Why did LaunchPulse build something different from what I expected?">
  ...
  <Accordion title="How do I prompt for design changes?">
  ...
  <Accordion title="Can one prompt include multiple roles?">
...
<Card title="Put your prompt to work" icon="bolt" href="/quickstart">
