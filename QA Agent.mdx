...
<img
  src="/images/TitleTheQAAgentYourAlways-On,Self-HealingTestEngineerVisualStyleAmodern,cleaninfographicwithadigital,interconnectedaesthetic.Useacolorpaletteofblues,purples,andgreensf.png"
  alt="QA Agent"
...
- **Completed tests** – flows the agent has already finished running
  ...
  <img src="/images/Screenshot2025-12-03at22.23.16.png" alt="Screenshot" style={{ width: '100%', maxWidth: '800px', borderRadius: '12px', margin: '20px 0' }} />
- **Upcoming tests** – flows that are queued next

  <img src="/images/Screenshot2025-12-03at22.30.51.png" alt="Screenshot" style={{ width: '100%', maxWidth: '800px', borderRadius: '12px', margin: '20px 0' }} />
...
<img src="/images/Screenshot2025-12-03at22.27.31.png" alt="Screenshot" style={{ width: '100%', maxWidth: '800px', borderRadius: '12px', margin: '20px 0' }} />
