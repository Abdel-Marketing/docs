---
title: "App Storage and Database: Persistent Data in LaunchPulse"
description: "Add app storage and a database in LaunchPulse so your app keeps persistent data, user records and files between every session."
icon: "database"
---
